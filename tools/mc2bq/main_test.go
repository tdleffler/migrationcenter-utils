...
func TestParseFlags(t *testing.T) {
	tCases := []struct {
		...
		{Name: "multiple regions via flag",
			Args: []string{"-region", "us-central1,europe-west1", "project", "dataset"},
			WantParams: export.Params{
				ProjectID:       "project",
				TargetProjectID: "project",
				DatasetID:       "dataset",
		...
		{Name: "multiple regions in env",
			Env:  map[string]string{"MC2BQ_REGION": "us-central1,europe-west1"},
			Args: []string{"project", "dataset"},
			WantParams: export.Params{
				ProjectID:       "project",
				TargetProjectID: "project",
		...
		{Name: "merge regions enabled",
			Env:  map[string]string{"MC2BQ_MERGE_REGIONS": "1"},
			Args: []string{"project", "dataset"},
			WantParams: export.Params{
				ProjectID:       "project",
				TargetProjectID: "project",
